...
@loggable
class CryptoHandler:
    __password = None         # Type: Optional[str]
    ...
    def get_encryption_handler(self) -> IncrementalAuthenticatedEncryption:
    ...
    def get_decryption_handler(self) -> IncrementalAuthenticatedEncryption:
    ...
    def on_auth_request(self, method: int, their_public_key: bytes, nonce: bytes) -> Tuple[bytes, bytes]:
        ...
        :param nonce: The nonce, or one time token, as generated by the server.
