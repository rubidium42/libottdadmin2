...
from libottdadmin2.packets import AdminAuthResponse, AdminJoin, AdminJoinNew, AdminQuit, Packet
...
class OttdClientMixIn:
    ...
    def on_server_auth_request(self, method: int, public_key: bytes, nonce: bytes):
    ...
    def on_server_enable_encryption(self):
        self.log.debug("Enabling encryption...")
        self._encryption_handler = self.__crypto_handler.get_encryption_handler()
        self._decryption_handler = self.__crypto_handler.get_decryption_handler()
